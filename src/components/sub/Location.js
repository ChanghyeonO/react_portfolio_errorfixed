...
export default function Location() {
    ...
    const info = [
        {
            title: '와이프 직장',
            latlng: new kakao.maps.LatLng(37.4982503, 127.0300905),
            imgUrl: `${process.env.PUBLIC_URL}/img/marker.png`,
            imgSize: new kakao.maps.Size(63, 99),
            imgPos: { offset: new kakao.maps.Point(116, 99) }
        },
        {
            title: '와이프 본가',
            latlng: new kakao.maps.LatLng(37.3997768, 126.9001542),
            imgUrl: `${process.env.PUBLIC_URL}/img/marker.png`,
            imgSize: new kakao.maps.Size(63, 99),
            imgPos: { offset: new kakao.maps.Point(116, 99) }
        },
        {
            title: '오창현의 집',
            latlng: new kakao.maps.LatLng(37.3993727, 126.7334962),
            imgUrl: `${process.env.PUBLIC_URL}/img/marker.png`,
            imgSize: new kakao.maps.Size(63, 99),
            imgPos: { offset: new kakao.maps.Point(116, 99) }
        },
